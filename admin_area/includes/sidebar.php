...
<nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top begin -->
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse"><!-- collapse navbar-collapse navbar-ex1-collapse begin -->
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#Announcements"><!-- a href begin -->
                        
                        <i class="fa fa-fw fa-tag"></i> Announcements 
                        <i class="fa fa-fw fa-caret-down"></i>
                        
                </a><!-- a href finish -->
                <ul id="Announcements" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?insert_announcements"> Insert Announcements </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
